...
public class SchoolStoreAssignment {
    public static void main(String[] args) {
        String content = "Java File Handling Practice";
        char array[] = new char[100];
        // Creating a file
        File fileObj = new File("assignment.txt");
        try {
        ...
        try {
            FileWriter fileWriterObj = new FileWriter("assignment.txt");
        ...
        try {
            FileReader fileReaderObj = new FileReader("assignment.txt");
